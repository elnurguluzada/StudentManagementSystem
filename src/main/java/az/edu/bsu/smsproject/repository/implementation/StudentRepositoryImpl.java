...
//    ---------------------------------------------------------------------------------
    ...
    public boolean delete(long userId) {
        return deleteStudentFromBduUser(userId)==1 &&
                deletStudentFromStudent(userId)==1 &&
                deleteStudentFromStudentSocialStatus(userId)==1;
    }

    private int deleteStudentFromBduUser(long userId){
        String sql = "DELETE FROM bdu_user WHERE user_id = ?";
        return jdbcTemplate.update(sql, userId);
    }

    private int deletStudentFromStudent(long userId){
        String sql = "DELETE FROM student WHERE user_id = ?";
        return jdbcTemplate.update(sql, userId);
    }
    private int deleteStudentFromStudentSocialStatus(long userId){
